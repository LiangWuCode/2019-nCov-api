...
public class StatisticsController {
    ...
    public Result totalDataThree() {
        ...
        try {
            ...
            //国际数据统计
            String newsHeadlines = doc.select("#getListByCountryTypeService2").html();
            newsHeadlines = StrUtil.removePrefix(newsHeadlines, "try { window.getListByCountryTypeService2 =");
            ...
            //国内新增数据
            String newsHeadlines2 = doc.select("#getListByCountryTypeService1").html();
            newsHeadlines2 = StrUtil.removePrefix(newsHeadlines2, "try { window.getListByCountryTypeService1 =");
